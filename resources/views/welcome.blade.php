    ...
    <div class="relative px-6 lg:px-8">
        <div class="max-w-3xl pt-20 pb-32 mx-auto sm:pt-48 sm:pb-40">
          <div>
            ...
            <div>
              <h1 class="text-4xl font-bold tracking-tight sm:text-center sm:text-6xl">Got lost? Got nowhere to stay? No idea where to go?</h1>
              <p class="mt-6 text-lg leading-8 text-gray-600 sm:text-center">With Kuan, we can generate places for you to stop, stay and chill.</p>
